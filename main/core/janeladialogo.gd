...
func _ready() -> void:
	...
	balloon.hide()
	balloon.custom_minimum_size.x = balloon.get_viewport_rect().size.x / 2
...
func handle_resize() -> void:
	...
	balloon.global_position = Vector2((viewport_size.x - balloon.size.x) * 0.5, viewport_size.y - balloon.size.y - 50)
